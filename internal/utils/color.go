...
func Successf(format string, a ...any) {
	_, _ = color.New(color.FgGreen, color.Bold).Printf(format, a...)
}

// Warnf prints a yellow warning line to stdout.
func Warnf(format string, a ...any) {
	_, _ = color.New(color.FgYellow).Printf(format, a...)
}

// Errorf prints a red error line to stdout.
func Errorf(format string, a ...any) {
	_, _ = color.New(color.FgRed, color.Bold).Printf(format, a...)
}

// Cyanf prints a cyan info line to stdout.
func Cyanf(format string, a ...any) {
	_, _ = color.New(color.FgCyan).Printf(format, a...)
}
